...
export const createSubject = asyncWrapper(
  async (req: Request, res: Response) => {
    const { name } = req.body;
...
//Deleting a subject
export const deleteSubject = asyncWrapper(
  async (req: Request, res: Response) => {
...
//Update Subject
export const updateSubject = asyncWrapper(
  async (req: Request, res: Response) => {
    const { subjectId } = req.params;
...
// Update a question in a quiz
export const updateQuestion = asyncWrapper(
  async (req: Request, res: Response) => {
    const { quizId, questionId } = req.params;
    const { question, choices, correctOption, explanation } = req.body;
...
export const getAdminStats = asyncWrapper(
  async (req: Request, res: Response) => {
